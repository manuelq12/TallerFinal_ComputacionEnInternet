...
public class Tmio1Bus implements Serializable {
	...
	@NotNull(message = "Debe escoger un número entre el rango [1;n]")
	private BigDecimal capacidad;

	@NotBlank(message = "Debe escribir una marca")
	@NotNull(message = "Debe escribir una marca")
	private String marca;

	@NotNull(message = "Debe escribir el año del modelo ")
	private BigDecimal modelo;

	@NotNull(message = "Debe escribir una placa")
	@NotBlank(message = "Debe escribir una placa")
