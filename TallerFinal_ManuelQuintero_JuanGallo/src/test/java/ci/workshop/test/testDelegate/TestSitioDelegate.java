...
//	private BusControllerRest busRest;
	...
	public void initMocks() {
	  ...
	  public void testSitioFindAll() {
		  ...
		  s2.setId(2);
			...
			when(rest.exchange(sitioDel.REST_URI +"/sitio/all",HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<List<Tmio1Sitio>>>() {
			})).thenReturn(re);
	...
	public void testFindById() {
		...
		when(rest.exchange(sitioDel.REST_URI +"/sitio/" + s1.getId(),HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<Tmio1Sitio>>() {
		})).thenReturn(re);
		...
		when(rest.exchange(sitioDel.REST_URI +"/sitio/" + s2.getId(),HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<Tmio1Sitio>>() {
		})).thenReturn(null);
