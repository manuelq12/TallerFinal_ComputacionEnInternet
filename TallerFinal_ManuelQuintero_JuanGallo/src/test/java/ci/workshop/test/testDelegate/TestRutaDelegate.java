...
//	private BusControllerRest busRest;
	...
	public void initMocks() {
	  ...
	  public void testRouteFindAll() {
			...
			when(rest.exchange(rutaDel.REST_URI +"/rute/all",HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<List<Tmio1Ruta>>>() {
			})).thenReturn(re);
	...
	public void testFindById() {
		...
		when(rest.exchange(rutaDel.REST_URI +"/rute/" + ruta.getId(),HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<Tmio1Ruta>>() {
		})).thenReturn(re);
		...
		when(rest.exchange(rutaDel.REST_URI +"/rute/" + ruta2.getId(),HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<Tmio1Ruta>>() {
		})).thenReturn(null);
	  ...
	  public void testRutaFindAllStates() {
		  ...
		  Tmio1Ruta ruta = new Tmio1Ruta();
			...
			when(rest.exchange(rutaDel.REST_URI +"/rute/states",HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<List<String>>>() {
			})).thenReturn(re);
