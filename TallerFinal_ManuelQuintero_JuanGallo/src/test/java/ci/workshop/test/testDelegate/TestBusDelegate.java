...
//	private BusControllerRest busRest;
	...
	public void initMocks() {
	  ...
	  public void testBusFindAll() {
			...
			when(rest.exchange(busDel.REST_URI +"/bus/all",HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<List<Tmio1Bus>>>() {
			})).thenReturn(re);
	...
	public void testFindById() {
		...
		when(rest.exchange(busDel.REST_URI +"/bus/" + bus.getId(),HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<Tmio1Bus>>() {
		})).thenReturn(re);
		...
		when(rest.exchange(busDel.REST_URI +"/bus/" + bus2.getId(),HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<Tmio1Bus>>() {
		})).thenReturn(null);
	  ...
	  public void testBusFindAllTypes() {
			...
			when(rest.exchange(busDel.REST_URI +"/bus/types",HttpMethod.GET,null, new ParameterizedTypeReference<TransactionBody<List<String>>>() {
			})).thenReturn(re);
